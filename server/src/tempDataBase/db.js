exports.skills = [
    ...
    },
    {
        ...
        ranks: [
            { effects: [
                { icon: "spell-fireball", description: "Spell: \"Pan's Impenetrable Pelt Upgraded\"" },
                { icon: "spell-fireball", description: "Overcast spell: \"Pan's Impenetrable Pelt Upgraded\"" },
                { icon: "spell-fireball", description: "Cooldown: -30% to \"Pan's Impenetrable Pelt\"" }
            ] },
            { effects: [
                { icon: "spell-fireball", description: "Overcast spell: \"Pan's Impenetrable Pelt Upgraded\"" },
                { icon: "spell-fireball", description: "Cooldown: -50% to \"Pan's Impenetrable Pelt\"" },
                { icon: "spell-fireball", description: "Winds of Magic cost: -1 for \"Pan's Impenetrable Pelt\"" },
                { icon: "spell-fireball", description: "Winds of Magic cost: -2 for \"Pan's Impenetrable Pelt Upgraded\"" },
                { icon: "spell-fireball", description: "Miscast base chance: -15% for \"Pan's Impenetrable Pelt Upgraded\"" }
            ] }
        ],
        spell: {
            description: "Spell",
